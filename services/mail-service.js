...
var mails = [
    ...
    {id: utils.makeId(),sender:'Shimon' ,subject: 'Meeting', body: 'Are you comming ?', isRead: false, sentAt : 1551133930594},
    {id: utils.makeId(),sender:'PANDORA' ,subject: 'Promosion', body: 'Ther is A great SALE today!!', isRead: false, sentAt : 1551133930594},
    {id: utils.makeId(),sender:'Collage' ,subject: 'New PaymentBill', body: 'The new Payment for the new academic year', isRead: false, sentAt : 1551133930594},
    ...
    {id: utils.makeId(),sender:'THE OFFICE' ,subject: 'MY UGLY BOSS', body: 'YOU ARE FIRED!!!', isRead: false, sentAt : 1551133930594},
